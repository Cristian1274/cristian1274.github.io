...
if (isset($_SESSION['loggedin']) && $_SESSION['loggedin'] === true && $_SESSION['Id_Rol'] === 3) {
    echo "<button class='gray-button' onclick=\"window.location.href='cerrar_sesion.php';\" id='btnPago'>Cerrar sesión</button>";
...
<footer class="pie-pagina">
    ...
    <div class="container5">
        ...
        $sql = "SELECT * FROM producto WHERE id_categoria = 2";
        if (!empty($termino)) {
